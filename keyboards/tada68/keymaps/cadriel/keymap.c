...
[_BL] = LAYOUT_ansi(
  ...
  KC_LCTL, KC_LGUI,KC_LALT,                KC_SPC,                        KC_RCTL,KC_NO,MO(_FL), KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = LAYOUT_ansi(
  ...
  _______,_______,_______,BL_DEC, BL_TOGG,BL_INC, _______,_______,_______,_______,_______,_______, KC_MSTP, KC_END, \
