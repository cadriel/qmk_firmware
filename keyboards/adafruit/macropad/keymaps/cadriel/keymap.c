...
tap_dance_action_t tap_dance_actions[] = {
    [TD_PDOT_PAST] = ACTION_TAP_DANCE_DOUBLE(KC_PDOT, KC_PAST),
    [TD_P0_PSLS] = ACTION_TAP_DANCE_DOUBLE(KC_P0, KC_PSLS),
    [TD_F4_NUM] = ACTION_TAP_DANCE_DOUBLE(KC_F4, KC_NUM)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_P4,         KC_P5,          KC_P6,
      KC_P1,         KC_P2,          KC_P3,
      TD(TD_F4_NUM), TD(TD_P0_PSLS), TD(TD_PDOT_PAST)
  ),
  [1] = LAYOUT(
                         _______,
